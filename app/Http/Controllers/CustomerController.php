...
class CustomerController extends Controller
{
    ...
    public function autocompletesearch(Request $request)
    {
        ...
        if(count($customers ) > 0){
            foreach ($customers  as $customer) {
                $results[] = [ 'id' => $customer['id'], 'text' => $customer['name'].' '.$customer['mobile'].' '.$customer['address']];                  
            }
    ...
    public function report($id)
    {
        ...
        $bills = Bill::where('customer_id','=', $id)->groupBy('token')->get();
        return view('pages.customer.report',compact('customer','bills'));
    }
